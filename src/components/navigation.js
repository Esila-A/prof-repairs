  ...
  return (
    <nav className="navigation">
      ...
      <dev className="navigation_main-nav">
        ...
        <NavHashLink to="/#services" className="navigation_main-nav--link" onClick={() => props.isMobilePhone && props.closeMenu()}>USŁUGI</NavHashLink>
        <NavHashLink to="/about/#about" className="navigation_main-nav--link" onClick={() => props.isMobilePhone && props.closeMenu()}>O NAS</NavHashLink>
